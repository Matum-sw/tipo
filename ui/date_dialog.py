...
class DateDialog(QDialog):
    def __init__(self, selected_date: QDate, parent=None, dark_mode: bool = False):
    ...
    def build(self, selected_date: QDate) -> None:
        ...
        self.calendar.setStyleSheet(self._calendar_style(self.dark_mode))
    ...
    @staticmethod
    def _calendar_style(dark_mode: bool) -> str:
        if dark_mode:
            return """
                QCalendarWidget {
                    background: #1a2030;
                ...
                QCalendarWidget QSpinBox {
                    ...
                    font-weight: 700;
                    min-width: 56px;
                    selection-background-color: #2a4580;
                }
                QCalendarWidget QAbstractItemView {
                    background: #1a2030;
                    alternate-background-color: #1a2030;
                    selection-background-color: #2f6fe8;
